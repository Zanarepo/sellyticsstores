        ...
        <div className="p-6 space-y-8 overflow-y-auto">
          ...
          {schedule.reason && (
            <div className="p-6 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-900/20 dark:to-cyan-900/20 rounded-xl">
              ...
              <p className="text-lg text-slate-900 dark:text-white italic">
                "{schedule.reason}"
              </p>
            </div>
          )}
          ...
          <div className="flex flex-wrap gap-4 justify-end">
            ...
            {isAdmin && isPendingRequest && (
              <>
                <button
                  ...
                  className="px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-xl transition shadow-md"
                >
                  Approve Request
                </button>
                <button
                  onClick={handleReject}
                  className="px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-medium rounded-xl transition shadow-md"
                >
                  Reject Request
                </button>
              </>
            ...
            {!isAdmin && isOwnRequest && isPendingRequest && (
              <button
                ...
                className="px-6 py-3 bg-orange-600 hover:bg-orange-700 text-white font-medium rounded-xl transition shadow-md"
              >
                Cancel Request
              </button>
            )}
            ...
            {isAdmin && (
              <button
                ...
                className="px-6 py-3 bg-gray-600 hover:bg-gray-700 text-white font-medium rounded-xl transition shadow-md"
              >
                Delete Schedule
              </button>
            )}
