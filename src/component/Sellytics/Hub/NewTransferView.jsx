 ...
 return (
  <div className="grid lg:grid-cols-3 gap-2 sm:gap-3">
            ...
            {filteredProducts.map((item) => {
              ...
              return (
                <motion.div
                  ...
                  className={`p-2 sm:p-2.5 rounded-lg border-2 cursor-pointer transition ${
                    selected
    ...
    <div className="bg-white rounded-lg sm:rounded-xl shadow-sm border border-slate-200">
      {/* Header */}
      <div className="p-2.5 sm:p-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-t-lg sm:rounded-t-xl">
        <div className="flex justify-between items-center">
