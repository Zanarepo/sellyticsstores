    ...
    <AnimatePresence>
      ...
      >
        ...
        >
          ...
          {/* Quick Stats */}
          <div className="grid grid-cols-3 gap-3 p-5 border-b dark:border-slate-800">
          ...
          {/* Tab Navigation */}
          <div className="flex gap-1 p-2 mx-5 mt-3 bg-slate-100 dark:bg-slate-800 rounded-xl">
            {[
                    ...
                    <div className="max-h-32 overflow-y-auto space-y-1">
                      {imeis.length === 0 ? (
                        ...
                        imeis.map((imei, idx) => (
                          <div 
                            key={idx} 
                            className="px-3 py-2 bg-slate-50 dark:bg-slate-800 rounded-lg text-sm font-mono"
                          >
                            {imei}
                          </div>
                        ))
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                {!isUnique && (
                  <>
                    <button 
                      onClick={onRestock} 
                      className="flex flex-col items-center gap-1 p-3 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 rounded-xl hover:bg-emerald-200 transition-colors"
                    >
                    ...
                    <button 
                      onClick={onAdjustQty} 
                      className="flex flex-col items-center gap-1 p-3 bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 rounded-xl hover:bg-amber-200 transition-colors"
                    >
                    ...
                    <button 
                      onClick={onEdit} 
                      className="flex flex-col items-center gap-1 p-3 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 rounded-xl hover:bg-indigo-200 transition-colors"
                    >
                ...
                {canDelete && (
                  <button 
                    onClick={onDelete} 
                    className="flex flex-col items-center gap-1 p-3 bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 rounded-xl hover:bg-red-200 transition-colors"
                  >
