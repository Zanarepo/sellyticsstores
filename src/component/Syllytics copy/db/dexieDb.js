...
db.version(4).stores({
  // ==================== CORE ENTITIES ====================
  dynamic_product: 'id,store_id,name,device_id,is_unique,created_at,updated_at,[store_id+device_id],[store_id+_offline_status+created_at]',
  ...
  product_inventory_adjustments_logs: '++id,_offline_id,store_id,dynamic_product_id,_offline_status,created_at,[store_id+_offline_status+created_at]',
